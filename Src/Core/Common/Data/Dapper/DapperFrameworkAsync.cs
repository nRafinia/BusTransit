...
namespace Common.Data.Dapper
{
    ...
    internal static partial class DapperFramework
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var query = await connection.QueryAsync<T>(new CommandDefinition(sb.ToString(), dynParms, transaction,
            ...
            object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null, CancellationToken cancellationToken = default)
        {
            ...
            if (!string.IsNullOrWhiteSpace(conditions) && !conditions.ToLower().Contains("where"))
            ...
            IDbTransaction transaction = null, int? commandTimeout = null, CancellationToken cancellationToken = default)
        {
            ...
            var r = await connection.QueryAsync(new CommandDefinition(sb.ToString(), entityToInsert, transaction, commandTimeout,cancellationToken:cancellationToken));
            ...
            System.Threading.CancellationToken? cancellationToken = null)
        {
            ...
            return connection.ExecuteAsync(new CommandDefinition(sb.ToString(), entityToUpdate, transaction,
                commandTimeout, cancellationToken: cancelToken));
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await connection.QueryFirstOrDefaultAsync<T>(new CommandDefinition(procedureName, parameters,
                ...
                CommandType.StoredProcedure, cancellationToken: cancellationToken));
            //var res= await connection.QueryAsync<T>(procedureName, parameters, transaction, commandTimeout, CommandType.StoredProcedure);
            //var res= await connection.QueryAsync<T>(procedureName, parameters, commandType: CommandType.StoredProcedure);
